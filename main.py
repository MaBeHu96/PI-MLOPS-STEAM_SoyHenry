...
@app.get("/earlyacces/{earlyacces: str}")
def earlyacces(year):
...
@app.get("/sentiment/{sentiment: str}")
def sentiment(year):
...
@app.get("/metascore/{metascore: str}")
def metascore(year):
